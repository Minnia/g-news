...
const favoritesController = __importStar(require("./favorites.controller"));
const favoritesRouter = express_1.default.Router();
favoritesRouter.get("/", favoritesController.getFavorites);
// http://localhost:3002/api/v1/favorites
favoritesRouter.post("/", favoritesController.addFavorite);
favoritesRouter.get("/ping", (req, res) => res.send("ding from favorites"));
